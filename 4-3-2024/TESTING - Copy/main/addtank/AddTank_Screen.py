...
class AddTankScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.tank_id_label = Label(text=initial_tank_id, color=(0, 0, 0, 1), size_hint=(None, None), size=(150, 40), halign='right', valign='middle')
        self.text_input_layout.add_widget(self.tank_id_label)
    ...
    def submit_form(self, instance):
        # Generate a Tank ID
        tank_id = self.generate_tank_id()
        self.tank_id_label.text = tank_id  # Update the Tank ID label
